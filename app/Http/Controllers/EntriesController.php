...
function autolinker_js()
{
    ...
    // Copy paste from https://github.com/Kapeli/Autolinker.js/blob/master/dist/Autolinker.min.js, just need to replace \ with \\ for some reason
